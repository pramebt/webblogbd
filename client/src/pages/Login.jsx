        ...
        <div className='bg-black w-full h-screen flex justify-center items-center p-10'>
            ...
            <div className='absolute bg-[#5882C1]/80 w-[300px] h-[500px] md:w-[400px] md:h-[500px] rounded-4xl z-0'>
                ...
                <div className='px-5 md:px-10'>
                    ...
                    <input placeholder='username@gmail.com' type="email" className='bg-white w-65 md:w-80 h-10 rounded-md px-4'/>

                    <h2 className='text-white mt-5 mb-2'>Password</h2>
                    <input placeholder='password'type="text" className='bg-white w-65 md:w-80 h-10 rounded-md px-4'/>

                </div>
                <div className='flex justify-center  mt-10 '>
                    <button className='bg-[#003465] text-white w-65 md:w-80 h-10 rounded-md cursor-pointer '>Sign in</button>
                </div>
            </div>
        </div>
    </form>
